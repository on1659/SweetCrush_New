...
public:
	...
	*/
	...
	int GetComponetSize() const { return m_vComponent.size(); }
...
public:
	...
	AnimState GetCurrentAnimationState() const { return m_currentAnimationState; }
	float GetAnimationSpeed() const { return m_animPlaySpeed; }

	void SetAnimationSpeed(float speed) { m_animPlaySpeed = speed; };
	void SetCurrentKeyframe(int keyframe) { m_currentKeyframe = keyframe; }
